	...
	<div class="nk-sidebar-element nk-sidebar-head">
		<div class="nk-sidebar-brand">
			<a href="<?= base_url('dashboard'); ?>" class="logo-link nk-sidebar-logo">
				<img class="logo-light logo-img" src="<?= base_url('uploads/' . $company_info['light_logo']); ?>" srcset="<?= base_url('uploads/' . $company_info['light_logo']); ?>" alt="logo">
				<img class="logo-dark logo-img" src="<?= base_url('uploads/' . $company_info['dark_logo']); ?>" srcset="<?= base_url('uploads/' . $company_info['dark_logo']); ?>" alt="logo-dark">
			</a>
		</div>
			...
			<div class="nk-sidebar-menu" data-simplebar>
				...
				<ul class="nk-menu" id="social-sidebar-menu">
					...
					<?php for ($i = 0; $i < count($menu); $i++) : ?>
						<li class="nk-menu-item <?php if (!empty($menu[$i]['child'])) {
													echo 'has-sub';
												} ?>">
							<a href="#" class="nk-menu-link <?php if (!empty($menu[$i]['child'])) {
																echo 'nk-menu-toggle';
															} ?>">
