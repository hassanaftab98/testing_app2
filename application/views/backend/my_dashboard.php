										...
										<div class="card card-preview">
											<div class="card-inner">
												<ul class="nav nav-tabs mt-n3">
													<li class="nav-item">
														<a class="nav-link " data-toggle="tab" href="#tabItem5"><em class="icon ni ni-user"></em><span>My Details</span></a>
													</li>
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#tabItem6"><em class="icon ni ni-folder"></em><span>Documents</span></a>
													</li>
															...
															<div class="row g-4">
																...
																<div class="col-sm-6">
																	<div class="form-group">
																		<label class="form-label">Degree of Interest</label>
																		<div class="form-control-wrap">
																			<select class="form-select form-control form-control-lg" data-search="on" data-placeholder="Program of Interest" name="" id="">
																				<option value="Program1">Program1</option>
																				<option value="BA">Program1</option>
																				<option value="MA">Program1</option>
																			</select>
																		</div>
																	</div>
																</div>
