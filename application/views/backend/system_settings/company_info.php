											...
											<div class="card-inner">
												...
												<form action="#" method="POST" id="company_info">
													<div class="row g-4">
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="form-label" for="default-06">Dark Logo</label>
																<div class="form-control-wrap">
																	<div class="custom-file">
																		<input type="file" multiple class="custom-file-input" name="dark_logo" id="dark_logo">
																		<label class="custom-file-label" for="dark_logo">Choose file</label>
																	</div>
																</div>
															</div>
															<div class="lg" >
															<img src="<?= base_url('uploads/'.$company_info['dark_logo']); ?>" alt="Company Logo"/>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="form-label" for="default-06">Light Logo</label>
																<div class="form-control-wrap">
																	<div class="custom-file">
																		<input type="file" multiple class="custom-file-input" name="light_logo" id="light_logo">
																		<label class="custom-file-label" for="light_logo">Choose file</label>
																	</div>
																</div>
															</div>
															<div class="lg" >
															<img src="<?= base_url('uploads/'.$company_info['light_logo']); ?>" alt="Company Logo"/>
